...
public class TopOs extends Query
{
	...
	{
		FilterBuilder fb = new OrFilterBuilder(new TermFilterBuilder("eventName", "TopOs"), new TermFilterBuilder("data.playerEvent", "str-start"));
	...
	{
		Terms byAssetName = this.searchResponse.getAggregations().get("by_os");
