...
public class TopOsJob extends WorkingJob<EventInfo>
{

	private static final long serialVersionUID = 4238311673383860862L;

	public TopOsJob(JavaRDD<EventInfo> inputDataset, DateTime timestamp, String timewindow)
	{
	...
	{
		JavaPairRDD<String, Integer> mappedRdd = this.inputDataset.mapToPair(t -> new Tuple2<String, Integer>(t.getOs(), 1));
		...
		JavaEsSpark.saveToEs(result, "vimond-batch/batch-topOs");
	}
