...
public class SimpleTopAssetsJob extends WorkingJob<SparkEvent>
{
	private static final long serialVersionUID = -8137849520886654258L;
	
	public SimpleTopAssetsJob(JavaRDD<SparkEvent> inputDataset, DateTime timestamp, String timewindow)
	{
