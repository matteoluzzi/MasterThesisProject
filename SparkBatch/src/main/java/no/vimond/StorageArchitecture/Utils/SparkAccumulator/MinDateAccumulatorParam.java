package no.vimond.StorageArchitecture.Utils.SparkAccumulator;

import java.util.Date;

import org.apache.spark.AccumulatorParam;

public class MinDateAccumulatorParam implements AccumulatorParam<Date>
{
	...
	public Date addAccumulator(Date accumulateDate, Date newDate)
	{
		if(accumulateDate.getTime() == 0)//initial case
			return newDate;
		if(accumulateDate.before(newDate))
