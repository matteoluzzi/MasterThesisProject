...
import no.vimond.RealTimeArchitecture.Kafka.kafkalibrary.PartitionManager.KafkaMessageId;
...
public class KafkaSpout extends BaseRichSpout {
    ...
    private final static Marker latency = MarkerManager.getMarker("PERFORMANCES-LATENCY");;
