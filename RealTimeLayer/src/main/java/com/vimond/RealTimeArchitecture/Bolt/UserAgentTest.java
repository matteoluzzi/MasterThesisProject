...
public class UserAgentTest implements IRichBolt
{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LogManager.getLogger(UserAgentTest.class);
	...
	public void initializeMetricsReport()
	{
		...
		this.counter = metricRegister.meter(MetricRegistry.name(UserAgentTest.class, Thread.currentThread().getName() + "-events_sec"));
