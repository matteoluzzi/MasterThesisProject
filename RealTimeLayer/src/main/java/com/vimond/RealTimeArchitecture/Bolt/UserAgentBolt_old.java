...
public class UserAgentBolt_old implements IRichBolt
{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LogManager.getLogger(UserAgentBolt_old.class);
...
//		this.acking = (Boolean) stormConf.get("acking");
	...
	public void initializeMetricsReport()
	{
		...
		this.counter = metricRegister.meter(MetricRegistry.name(UserAgentBolt_old.class, Thread.currentThread().getName() + "-events_sec"));
