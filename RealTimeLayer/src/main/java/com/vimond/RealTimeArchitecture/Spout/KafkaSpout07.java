...
import com.vimond.RealTimeArchitecture.Kafka.KafkaConsumer;
import com.vimond.RealTimeArchitecture.Kafka.StormEventProcessor;
...
public class KafkaSpout07 implements IRichSpout
{
	...
	{
		String zk_location = (String) conf.get("zookeeper.connect");
